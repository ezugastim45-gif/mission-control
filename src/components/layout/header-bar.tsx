...
export function HeaderBar() {
  ...
  return (
    <header aria-label="Application header" className="relative z-50 h-14 bg-card/80 backdrop-blur-sm border-b border-border px-3 md:px-4 shrink-0">
      ...
      {searchOpen && isMounted && createPortal(
        ...
        >
          <button type="button" aria-label="Close search" className="absolute inset-0 block w-full border-0 p-0 bg-gradient-to-b from-black/30 via-black/30 to-black/30 cursor-default" onClick={() => setSearchOpen(false)} />
