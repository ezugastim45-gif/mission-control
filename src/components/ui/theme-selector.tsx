...
export function ThemeSelector() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <>
          <button type="button" className="fixed inset-0 z-40 block w-full border-0 p-0 bg-transparent cursor-default" onClick={() => setOpen(false)} onKeyDown={(e) => { if (e.key === 'Escape') setOpen(false) }} aria-label="Close theme menu" />
